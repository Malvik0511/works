...
@Component({
  	...
  	styleUrls: ['./validation-message.component.css', './_pos/validation-message_pos.css', './_theme/validation-message_theme.css']
})
...
export class ValidationMessageComponent{
	...
	public get validatonMessages() {
	    ...
	    if (field.errors.hasOwnProperty('custom')) {
	        ...
	        field.errors.custom :  'Значение не соответствует форме';
	    }
